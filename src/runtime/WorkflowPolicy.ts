...
export const defaultWorkflowPolicies = {
  manual: {
    ...
    decisions: defineDecisions({
      ...
      "edit-github-issue": "blocked",
      "edit-github-project-item": "blocked",
  ...
  assisted: {
    ...
    decisions: defineDecisions({
      ...
      "edit-github-issue": "requires-confirmation",
      "edit-github-project-item": "requires-confirmation",
